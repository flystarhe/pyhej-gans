...
def main(args):
    ...
    parser.add_argument("--lr_g_step", type=int, default=200)
    parser.add_argument("--lr_g_gamma", type=float, default=0.1)
    parser.add_argument("--lr_d", type=float, default=0.0002)
    parser.add_argument("--lr_d_step", type=int, default=200)
    parser.add_argument("--lr_d_gamma", type=float, default=0.1)
